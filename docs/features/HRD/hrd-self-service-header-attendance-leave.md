...
| POST | `/hrd/leave-requests/self/:id/cancel` | Auth (Self) | Cancel personal leave request |
...
8. Edit pending/rejected request and verify update success.
9. Cancel pending/approved request and verify status changes.
