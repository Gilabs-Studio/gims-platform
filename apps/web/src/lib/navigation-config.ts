...
export const navigationConfig: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Customer Invoices DP", url: "/sales/customer-invoice-down-payments", icon: "banknote", permission: "customer_invoice_dp.read" },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: "building-2",
        children: [
          { name: "Assets", url: "/finance/assets", icon: "building-2", permission: "asset.read" },
