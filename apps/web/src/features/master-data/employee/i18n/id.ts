...
export const employeeId: EmployeeTranslations = {
  ...
  contract: {
    ...
    createDescription: "Buat kontrak baru untuk karyawan ini.",
    renewDescription:
  ...
  asset: {
    ...
    actions: {
      ...
      edit: "Edit Aset",
      delete: "Hapus Aset",
      return: "Kembalikan Aset",
      processing: "Memproses...",
    },
    empty: {
      noAssets: "Tidak ada aset yang ditetapkan untuk karyawan ini.",
    },
    form: {
    ...
    success: {
      ...
      returned: "Aset berhasil dikembalikan",
    },
    error: {
      createFailed: "Gagal menambahkan aset",
      updateFailed: "Gagal memperbarui aset",
      deleteFailed: "Gagal menghapus aset",
      returnFailed: "Gagal mengembalikan aset",
      duplicateCode: "Kode aset sudah digunakan",
    },
    daysBorrowedLabel: "{days} hari",
  },
  signature: {
    ...
    imageLoadError:
      "Gagal memuat gambar tanda tangan. File mungkin telah dipindahkan atau dihapus.",
  },
  validation: {
