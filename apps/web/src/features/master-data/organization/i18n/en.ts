export const organizationEn = {
  ...
  area: {
    ...
    detail: {
      ...
      members: "Members",
      supervisorCount: "{count} Supervisor(s)",
      memberCount: "{count} Member(s)",
      noSupervisor: "No Supervisor",
      noMembers: "No Members",
      noSupervisorWarning: "This area has no supervisor assigned",
      noMembersWarning: "This area has no members assigned",
    ...
    assign: {
      ...
      supervisorTitle: "Assign Supervisor to {area}",
      members: "Assign Members",
      membersTitle: "Assign Members to {area}",
    ...
    remove: {
      ...
      confirmTitle: "Remove Employee",
      confirmSupervisor: "Remove {name} as supervisor from this area?",
      confirmMember: "Remove {name} as member from this area?",
      success: "Employee removed from area successfully",
    },
    filter: {
      all: "All",
      hasSupervisor: "Has Supervisor",
      noSupervisor: "No Supervisor",
