...
export const AccountingMappingForm = () => {
  ...
  const requiredMappings = [
    ...
    { key: "coa.sales_revenue", label: "Sales Revenue", targetType: "INCOME" },
    { key: "coa.accounts_payable", label: "Accounts Payable (AP)", targetType: "LIABILITY" },
    { key: "coa.sales_receivable", label: "Accounts Receivable (AR)", targetType: "ASSET" },
    ...
    { key: "coa.vat_in", label: "VAT Input (PPN Masukan)", targetType: "ASSET" },
    { key: "coa.sales_vat_out", label: "VAT Output (PPN Keluaran)", targetType: "LIABILITY" },
