export const financeJournalsEn = {
  ...
  messages: {
    lockedEntry: "This journal entry is locked and cannot be modified.",
  },
  errors: {
    missing_account_mapping: "Account mapping is incomplete. Complete Finance Settings before posting.",
    missing_coa_settings: "Required accounting settings are missing.",
    already_posted: "This journal has already been posted.",
    locked_entry: "This journal is locked and cannot be changed.",
    insufficient_balance: "Insufficient balance.",
    duplicate_journal: "Duplicate journal detected.",
    unauthorized: "You do not have permission for this action.",
    not_found: "Journal data not found.",
    invalid_amount: "Invalid amount or journal line.",
  },
