...
import { useDeleteFinanceAssetCategory, useFinanceAssetCategories } from "../hooks/use-finance-asset-categories";
...
export function AssetCategoryList() {
  ...
  const { data, isLoading, isError } = useFinanceAssetCategories({
    page,
    per_page: pageSize,
  ...
  const deleteMutation = useDeleteFinanceAssetCategory();
  ...
  return (
    <div className="space-y-6">
      ...
      <AssetCategoryForm open={formOpen} onOpenChange={setFormOpen} mode={formMode} initialData={editing} />
