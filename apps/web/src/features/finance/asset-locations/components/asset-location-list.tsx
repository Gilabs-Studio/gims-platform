...
import { useDeleteFinanceAssetLocation, useFinanceAssetLocations } from "../hooks/use-finance-asset-locations";
import { AssetLocationForm } from "./asset-location-form";

export function AssetLocationList() {
  ...
  const [deleting, setDeleting] = useState<AssetLocation | null>(null);

  const { data, isLoading, isError } = useFinanceAssetLocations({
    page,
    per_page: pageSize,
  ...
  const deleteMutation = useDeleteFinanceAssetLocation();
  ...
  return (
    <div className="space-y-6">
      ...
      <AssetLocationForm open={formOpen} onOpenChange={setFormOpen} mode={formMode} initialData={editing} />
