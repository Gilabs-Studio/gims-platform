...
interface SupplierInvoiceDPPrintDialogProps {
  readonly open: boolean;
  readonly onClose: () => void;
  readonly invoiceId: string;
}

export function SupplierInvoiceDPPrintDialog({
  open,
  onClose,
  invoiceId,
}: SupplierInvoiceDPPrintDialogProps) {
  ...
  const handlePrint = async () => {
    ...
    setIsPrinting(true);
    try {
      await supplierInvoiceDPService.openPrintWindow(invoiceId, selectedCompanyId);
      onClose();
    } catch {
