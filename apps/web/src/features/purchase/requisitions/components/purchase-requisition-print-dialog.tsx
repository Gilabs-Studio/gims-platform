...
interface PurchaseRequisitionPrintDialogProps {
  readonly open: boolean;
  readonly onClose: () => void;
  readonly requisitionId: string;
}

export function PurchaseRequisitionPrintDialog({
  open,
  onClose,
  requisitionId,
}: PurchaseRequisitionPrintDialogProps) {
  ...
  const handlePrint = async () => {
    ...
    setIsPrinting(true);
    try {
      await purchaseRequisitionsService.openPrintWindow(
        requisitionId,
        selectedCompanyId
      );
      onClose();
