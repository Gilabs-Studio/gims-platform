                ...
                <TableRow key={it.id}>
                  ...
                  <TableCell className="max-w-[520px]">
                    {(() => {
                      ...
                      if (changes.length === 0) return <div className="text-xs text-muted-foreground">-</div>;
                        ...
                        <div className="max-h-[240px] overflow-auto pr-2">
                          <div className="space-y-1 text-xs">
                            ...
                            {changes.length > shown.length && (
                              <div className="text-xs text-muted-foreground">+{changes.length - shown.length} more</div>
                            )}
                          </div>
                        </div>
                      );
...
export function GoodsReceiptAuditTrail({ open, onClose, goodsReceiptId }: GoodsReceiptAuditTrailProps) {
  const t = useTranslations("goodsReceipt");  const tCommon = useTranslations("common");
