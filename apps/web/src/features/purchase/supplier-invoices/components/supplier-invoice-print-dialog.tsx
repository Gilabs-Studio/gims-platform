...
interface SupplierInvoicePrintDialogProps {
  readonly open: boolean;
  readonly onClose: () => void;
  readonly invoiceId: string;
}

export function SupplierInvoicePrintDialog({
  open,
  onClose,
  invoiceId,
}: SupplierInvoicePrintDialogProps) {
  ...
  const handlePrint = async () => {
    ...
    setIsPrinting(true);
    try {
      await supplierInvoicesService.openPrintWindow(invoiceId, selectedCompanyId);
      onClose();
    } catch {
