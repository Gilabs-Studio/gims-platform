...
const InvoiceItemCard = memo(({ item, tDetail }: { item: SupplierInvoiceItem; tDetail: ReturnType<typeof useTranslations> }) => {
  return (
  ...
  prev.item.sub_total === next.item.sub_total &&
              ...
              >
                {virtualizer.getVirtualItems().map((virtualItem) => {
                  ...
                  return (
                    ...
                    >
                      <InvoiceItemCard item={item} tDetail={tDetail} />
                    </div>
                  );
                })}
              </div>
