...
interface PurchasePaymentPrintDialogProps {
  readonly open: boolean;
  readonly onClose: () => void;
  readonly paymentId: string;
}

export function PurchasePaymentPrintDialog({
  open,
  onClose,
  paymentId,
}: PurchasePaymentPrintDialogProps) {
  ...
  const handlePrint = async () => {
    ...
    setIsPrinting(true);
    try {
      await purchasePaymentsService.openPrintWindow(paymentId, selectedCompanyId);
      onClose();
    } catch {
