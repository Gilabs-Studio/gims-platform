        ...
        <div className="flex gap-1">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  ...
                  disabled={isPending || isDenied || checkInTimeInfo.isTooEarly}
                >
                  {isPending ? (
              ...
              <DropdownMenuContent align="start" className="w-48">
                ...
                {checkInTimeInfo.isTooEarly && checkInTimeInfo.earliestTime && (
                  <div className="px-2 py-1.5 text-xs text-muted-foreground border-b">
                    <span className="text-amber-600 dark:text-amber-400">
                      {t("messages.checkInAvailableAt", {
          ...
          {(isDenied || isPrompt) && (
            <Button
              ...
              onClick={() => {
                if (isDenied) {
                  toast.info(t("location.deniedInstructions"), {
                    duration: 8000,
                  });
                } else {
                  requestPermission();
