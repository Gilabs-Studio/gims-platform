            ...
            <div className="space-y-6">
              ...
              {displayEvaluation.notes && (
                <div>
                  ...
                  <p className="mt-1 text-sm">{displayEvaluation.notes}</p>
                </div>
              )}
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-semibold">{t("evaluation.criteriaScores")}</h3>
                    ...
                    <Table>
                      <TableHeader>
                        <TableRow>
                          ...
                          <TableHead className="text-center">{t("evaluation.score")}</TableHead>
                          <TableHead className="text-center">{t("criteria.weight")}</TableHead>
                          <TableHead className="text-center">{t("evaluation.weightedScore")}</TableHead>
