...
export function TravelPlannerWidget() {
  ...
  const isLoading = plansQuery.isLoading || expenseQueries.some((query) => query.isLoading);
  const isError = plansQuery.isError || expenseQueries.some((query) => query.isError);
