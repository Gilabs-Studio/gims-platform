...
import type { MonthlyProductSalesData } from "../types";

export interface ProductAnalysisChartProps {
  readonly data: MonthlyProductSalesData[];
  ...
  readonly selectedMetric?: "revenue" | "qty" | "orders";
  readonly onMetricChange?: (metric: "revenue" | "qty" | "orders") => void;
...
export function ProductAnalysisChart({
  ...
  totalQty,
  totalOrders,
}: ProductAnalysisChartProps) {
  const t = useTranslations("productAnalysisReport.chart");
      ...
      <CardHeader>
            ...
            {onMetricChange && (
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="qty">{metricLabels.qty}</SelectItem>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-lg font-medium">{formatNumber(totalQty)}</p>
          </div>
          <div className="space-y-1">
            <p className="text-xs text-muted-foreground">
              {metricLabels.orders}
            </p>
            <p className="text-lg font-medium">{formatNumber(totalOrders)}</p>
          </div>
        </div>
      </CardHeader>
      <CardContent>
