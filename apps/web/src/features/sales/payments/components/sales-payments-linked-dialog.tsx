...
import { useSalesPaymentsLinkedDialog } from "../hooks/use-sales-payments-linked-dialog";
...
export function SalesPaymentsLinkedDialog({ invoiceCode, invoiceId, open, onOpenChange }: SalesPaymentsLinkedDialogProps) {
  ...
  const { canViewPayment, selectedPaymentId, setSelectedPaymentId, payments, isLoading } =
    useSalesPaymentsLinkedDialog({ open, invoiceId });
