...
interface CustomerInvoiceDPPrintDialogProps {
  readonly open: boolean;
  readonly onClose: () => void;
  readonly invoiceDpId: string;
}

export function CustomerInvoiceDPPrintDialog({
  open,
  onClose,
  invoiceDpId,
}: CustomerInvoiceDPPrintDialogProps) {
  ...
  const handlePrint = async () => {
    ...
    setIsPrinting(true);
    try {
      await customerInvoiceDPService.openPrintWindow(invoiceDpId, selectedCompanyId);
      onClose();
    } catch {
