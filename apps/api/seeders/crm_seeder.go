...
const (
	...
	leadStatusNewColor       = "#3B82F6"
	leadStatusContactedColor = "#F59E0B"
	leadStatusQualifiedColor = "#8B5CF6"
	leadStatusConvertedColor = "#10B981"
	leadStatusLostColor      = "#EF4444"
...
func seedLeadStatuses() error {
	...
	statuses := []crm.LeadStatus{
		{ID: LeadStatusNewID, Name: "New", Code: "NEW", Description: "Newly created lead", Score: 10, Color: colorPrimaryBlue, Order: 1, IsActive: true, IsDefault: true, IsConverted: false},
		{ID: LeadStatusContactedID, Name: "Contacted", Code: "CONTACTED", Description: "Lead has been contacted", Score: 30, Color: colorAmber, Order: 2, IsActive: true, IsDefault: false, IsConverted: false},
		{ID: LeadStatusQualifiedID, Name: "Qualified", Code: "QUALIFIED", Description: "Lead is qualified for opportunity", Score: 60, Color: colorPurple, Order: 3, IsActive: true, IsDefault: false, IsConverted: false},
		{ID: LeadStatusConvertedID, Name: "Converted", Code: "CONVERTED", Description: "Lead has been converted to pipeline/deal", Score: 100, Color: colorGreen, Order: 4, IsActive: true, IsDefault: false, IsConverted: true},
		{ID: LeadStatusLostID, Name: "Lost", Code: "LOST", Description: "Lead has been lost", Score: 0, Color: colorRed, Order: 5, IsActive: true, IsDefault: false, IsConverted: false},
	}

	for _, status := range statuses {
		if err := database.DB.Clauses(clause.OnConflict{
			Columns:   []clause.Column{{Name: "id"}},
			DoUpdates: clause.AssignmentColumns([]string{"name", "code", "description", "score", "color", "order", "is_active", "is_default", "is_converted", "updated_at"}),
...
func seedContactRoles() error {
	...
	roles := []crm.ContactRole{
		{ID: ContactRoleDirectorID, Name: "Director", Code: "DIRECTOR", Description: "C-level or director role", BadgeColor: colorRed, IsActive: true},
		{ID: ContactRoleManagerID, Name: "Manager", Code: "MANAGER", Description: "Department or division manager", BadgeColor: colorAmber, IsActive: true},
		{ID: ContactRolePICID, Name: "Person In Charge", Code: "PIC", Description: "Main contact person for operations", BadgeColor: colorPrimaryBlue, IsActive: true},
		{ID: ContactRolePurchasingID, Name: "Purchasing", Code: "PURCHASING", Description: "Purchasing or procurement contact", BadgeColor: colorPurple, IsActive: true},
		{ID: ContactRoleFinanceID, Name: "Finance", Code: "FINANCE", Description: "Finance or accounting contact", BadgeColor: colorGreen, IsActive: true},
	}
...
func seedActivityTypes() error {
	...
	types := []crm.ActivityType{
		{ID: ActivityTypeVisitID, Name: "Visit", Code: "VISIT", Description: "On-site customer visit", Icon: "map-pin", BadgeColor: colorPrimaryBlue, Order: 1, IsActive: true},
		{ID: ActivityTypeCallID, Name: "Call", Code: "CALL", Description: "Phone call with customer", Icon: "phone", BadgeColor: colorGreen, Order: 2, IsActive: true},
		{ID: ActivityTypeEmailID, Name: "Email", Code: "EMAIL", Description: "Email communication", Icon: "mail", BadgeColor: colorAmber, Order: 3, IsActive: true},
		{ID: ActivityTypeMeetingID, Name: "Meeting", Code: "MEETING", Description: "Scheduled meeting (online or offline)", Icon: "users", BadgeColor: colorPurple, Order: 4, IsActive: true},
		{ID: ActivityTypeFollowUpID, Name: "Follow Up", Code: "FOLLOW_UP", Description: "Follow-up activity on previous interaction", Icon: "refresh-cw", BadgeColor: colorCyan, Order: 5, IsActive: true},
	}
