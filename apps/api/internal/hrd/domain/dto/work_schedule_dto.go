...
type CreateWorkScheduleRequest struct {
	...
	BreakStartTime            string   `json:"break_start_time" binding:"omitempty,len=5"`
	BreakEndTime              string   `json:"break_end_time" binding:"omitempty,len=5"`
	BreakDuration             int      `json:"break_duration" binding:"omitempty,gte=0"`
	WorkingDays               int      `json:"working_days" binding:"required,gte=1,lte=127"` // Bitmask
	WorkingHoursPerDay        float64  `json:"working_hours_per_day" binding:"required,gt=0,lte=24"`
